...
public class Principal {
    public static void main (String[] args){
        ...
        do {
            ...
            System.out.println("3. Eres un trabajador");
                    ...
                    do { 
                        ...
                        switch (opcionTrabajador) {
                            ...
                            case 2://Agregar libros
                                ...
                                System.out.println("Cuál es el genero del nuevo libro: ");
                                generoNuevoLibro = null;
                                do{
                                    nGeneros = inventario.printGeneros();
                                    opcionGenero = sc.nextInt();
                                    sc.nextLine(); 
                                    if(opcionGenero>0 && opcionGenero<=nGeneros){
                                        generoNuevoLibro = inventario.numToGenero(opcionGenero);
                                    }else {
                                        System.out.println("No hay un estante de ese género.");
                                    }
                                }while(generoNuevoLibro == null);
